...
public class TicTacToeGameTest {
	...
	@Test
	public void checkIfAnyRowOfTheBoardIsOccupiedBySinglePlayer() throws PositionAlreadyOccupiedException, PositionOutOfRangeException {
	...
	@Test
	public void checkIfTopLeftToBottomRightDiagonalOfTheBoardIsOccupiedBySinglePlayer() throws PositionAlreadyOccupiedException, PositionOutOfRangeException {
		game.play(POS_0, POS_0);
		game.play(POS_0, POS_1);
		game.play(POS_1, POS_1);
		game.play(POS_2, POS_1);
	...
	@Test
	public void checkIfTopRightToBottomLeftDiagonalOfTheBoardIsOccupiedBySinglePlayer() throws PositionAlreadyOccupiedException, PositionOutOfRangeException {
		game.play(POS_0, POS_0);
		game.play(POS_2, POS_0);
		game.play(POS_1, POS_0);
		game.play(POS_1, POS_1);
	...
	@Test
	public void declarePlayerAsWinnerIfRowIsOccupiedByHim() throws PositionAlreadyOccupiedException, PositionOutOfRangeException {
		game.play(POS_0, POS_0);
		game.play(POS_1, POS_1);
		game.play(POS_0, POS_1);
		game.play(POS_2, POS_1);
		assertEquals("Winner is Player_X", game.play(POS_0, POS_2));
	}
	
	@Test
	public void declarePlayerAsWinnerIfColumnIsOccupiedByHim() throws PositionAlreadyOccupiedException, PositionOutOfRangeException {
		game.play(POS_0, POS_0);
		game.play(POS_1, POS_1);
		game.play(POS_1, POS_0);
		game.play(POS_2, POS_1);
		assertEquals("Winner is Player_X", game.play(POS_2, POS_0));
	}
	
	@Test
	public void declarePlayerAsWinnerIfAnyDiagonalIsOccupiedByHim() throws PositionAlreadyOccupiedException, PositionOutOfRangeException {
		game.play(POS_0, POS_0);
		game.play(POS_2, POS_0);
		game.play(POS_1, POS_0);
		game.play(POS_1, POS_1);
